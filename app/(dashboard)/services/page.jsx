...
const Services = async () => {
  ...
  return (
    <div className="bg-white">
      <div className="text-xl font-semibold mb-4">Layanan & Tarif</div>
      <div className="w-full flex flex-row border-t border-gray-200">
        <div className="w-1/5 border-r border-gray-200 pt-8 hidden lg:block">
          ...
          <ul>
            ...
            <li className="text-sm py-2">Cuci Mobil</li>
            <li className="text-sm py-2">Cuci Motor</li>
            <li className="text-sm py-2">Darurat</li>
            <li className="text-sm py-2">Spesialis</li>
          </ul>
        </div>
                      ...
                      {data?.map((item, index) => (
                        ...
                        >
                          ...
                          <td className="full flex justify-center py-4 px-2">
                            <Link
                              href={`/services/price?id=${item.id}`}
